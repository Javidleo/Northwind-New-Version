        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    file_stream = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    path_locator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    parent_path_locator = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    file_type = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    cached_file_size = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    last_access_time = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    is_directory = table.Column<bool>(type: "bit", nullable: false),
                    is_offline = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentView", x => x.stream_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FileSystemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
